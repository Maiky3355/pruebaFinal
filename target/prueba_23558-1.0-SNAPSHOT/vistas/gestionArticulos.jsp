            ...
            <div class="offcanvas-body">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                                   <div class="card">
                           <iframe src="gestionCarrito.jsp" height="500" style="border:0; overflow: hidden;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        ...
                        <div class="d-flex">
                            ...
                            <form action="registroCarrito" method="post" class="mr-2">
                             ...
                             <p>cantidad <input type="text" name="cantidad" value="1" style="width: 5vh">
                                     <input type="hidden" name="venta" value=" <%= articulo.getVenta()%>">
